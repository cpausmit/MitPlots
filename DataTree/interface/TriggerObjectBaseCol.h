// $Id: TriggerObjectCol.h,v 1.1 2009/06/15 15:00:14 loizides Exp $

#ifndef MITANA_DATATREE_TRIGGEROBJECTBASECOL_H
#define MITANA_DATATREE_TRIGGEROBJECTBASECOL_H
