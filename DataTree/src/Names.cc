// $Id: Names.cc,v 1.54 2011/11/24 11:30:41 pharris Exp $
...
const char *Names::gkEmbedWeightBrn         = "EmbedWeight";
const char *Names::gkEvtHeaderBrn           = "EventHeader";
const char *Names::gkEvtSelDataBrn          = "EvtSelData";
...
const char *Names::gkPileupEnergyDensityBrn = "Rho";
const char *Names::gkMuonBrn                = "Muons";
const char *Names::gkMvfConversionBrn       = "MergedConversions";
...
const char *Names::gkHltMenuBrn             = "HLTMenus";
